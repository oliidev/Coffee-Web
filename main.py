...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///C:\\Users\\742232\\DB.Browser.for.SQLite-v3.13.1-win64\\beanandbrew.db'
app.config['SECRET_KEY'] = 'your-secret-key-here'  # secret key is here
